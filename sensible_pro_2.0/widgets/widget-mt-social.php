...
class sensible_social extends WP_Widget { 
	
	
// constructor

    function sensible_social() {

		$widget_ops = array('classname' => 'sensible_social_widget', 'description' => esc_html__( 'Drag this widget to the Social Widget Area.', 'sensible') );

        parent::__construct(false, $name = esc_html__('MT - Social Icons', 'sensible'), $widget_ops); 

		$this->alt_option_name = 'sensible_social_widget';
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id( 'social_url_path' )); ?>"><?php esc_html_e( 'Check this box to open links in a new window.', 'sensible' ); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_fb_link')); ?>"><?php esc_html_e('Facebook URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_twitter_link')); ?>"><?php esc_html_e('Twitter URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_linked_link')); ?>"><?php esc_html_e('LinkedIn URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_google_link')); ?>"><?php esc_html_e('Google URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_instagram_link')); ?>"><?php esc_html_e('Instagram URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_snapchat_link')); ?>"><?php esc_html_e('Snapchat URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_vine_link')); ?>"><?php esc_html_e('Vine URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_flickr_link')); ?>"><?php esc_html_e('Flickr URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_pinterest_link')); ?>"><?php esc_html_e('Pinterest URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_youtube_link')); ?>"><?php esc_html_e('Youtube URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_vimeo_link')); ?>"><?php esc_html_e('Vimeo URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_tumblr_link')); ?>"><?php esc_html_e('Tumblr URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_stumble_link')); ?>"><?php esc_html_e('StumbleUpon URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_dribbble_link')); ?>"><?php esc_html_e('Dribbble URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_yelp_link')); ?>"><?php esc_html_e('Yelp URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_vk_link')); ?>"><?php esc_html_e('VK URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_xing_link')); ?>"><?php esc_html_e('Xing URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_deviant_link')); ?>"><?php esc_html_e('DeviantArt URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_500_link')); ?>"><?php esc_html_e('500px URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_behance_link')); ?>"><?php esc_html_e('Behance URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_lastfm_link')); ?>"><?php esc_html_e('lastFM URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_soundcloud_link')); ?>"><?php esc_html_e('SoundCloud URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_reddit_link')); ?>"><?php esc_html_e('Reddit URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_github_link')); ?>"><?php esc_html_e('Github URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_codepen_link')); ?>"><?php esc_html_e('CodePen URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_skype_link')); ?>"><?php esc_html_e('Skype URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_spotify_link')); ?>"><?php esc_html_e('Spotify URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_weibo_link')); ?>"><?php esc_html_e('Weibo URL:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_email_link')); ?>"><?php esc_html_e('Email Address:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_telephone_link')); ?>"><?php esc_html_e('Phone Number:', 'sensible'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_rss_link')); ?>"><?php esc_html_e('RSS URL:', 'sensible'); ?></label>
	...
	function update($new_instance, $old_instance) { 
		...
		if ( isset($alloptions['sensible_social']) )

			delete_option('sensible_social');		  
	...
	function flush_widget_cache() {
		...
		wp_cache_delete('sensible_social', 'widget');
	...
	function widget($args, $instance) {
		...
		if ( ! $this->is_preview() ) {
			...
			$cache = wp_cache_get( 'sensible_social', 'widget' );
...
?>
	...
	<?php
		...
		if ( ! $this->is_preview() ) {
			...
			wp_cache_set( 'sensible_social', $cache, 'widget' ); 
