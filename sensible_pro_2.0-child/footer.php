...
<script>			jQuery.post( "http:\/\/angelaestate.com\/", {
    	...
    	<div class="grid grid-pad">
			...
			<div class="site-info col-1-1">
				...
				<?php else : ?>  
					...
					<?php echo '<a href="//darkmassdesign.com">Dark Mass Design</a> | All Rights Reserved | &copy ', Date('Y'); ?> 
