...
//-------------------------------------------------------------------------------------------------------------------// 
    ...
    'theme_supports' => '', 
    'title'          => __( 'General Colors', 'sensible' ),
    'description'    => __( 'Edit your general color settings.', 'sensible' ),
	)); 
    ...
    'capability'     => 'edit_theme_options',
    'theme_supports' => '',
    'title'          => __( 'Header | Navigation', 'sensible' ),
    'description'    => __( 'Edit your theme navigation settings.', 'sensible' ), 
	));
	
	// nav 
	$wp_customize->add_section( 'nav', array(
	'title' => __( 'Navigation', 'sensible' ),
	'priority' => '10', 
	...
	'title' => __( 'Theme Colors', 'sensible' ), 
	'priority' => '10', 
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_custom_color', array(
        'label'	   => __( 'Theme Color', 'sensible' ),
		'description' => __( 'This color will change various objects like Buttons and Page Header colors', 'sensible' ),
        'section'  => 'colors',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_site_title_color', array(
        'label'	   => __( 'Site Title Color', 'sensible' ),  
        'section'  => 'colors',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_blockquote', array(
        'label'	   => __( 'Blockquote Background', 'sensible' ),
        'section'  => 'colors',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_blockquote_border', array(
        'label'	   => __( 'Blockquote Accent Color', 'sensible' ), 
        'section'  => 'colors',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_entry', array(
        'label'	   => __( 'Entry Title Color', 'sensible' ), 
        'section'  => 'colors',
    ...
    $wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'sensible_menu_name', array(
        'label'	   => __( 'Mobile Menu Name', 'sensible' ),
        'section'  => 'nav',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_nav_link_color', array(
        'label'	   => __( 'Navigation Link Color', 'sensible' ),
        'section'  => 'nav',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_nav_link_hover_color', array(
        'label'	   => __( 'Navigation Link Hover Color', 'sensible' ),
        'section'  => 'nav',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_nav_drop_link_color', array(
        'label'	   => __( 'Menu Drop Down Link Color', 'sensible' ),
        'section'  => 'nav',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_mobile_menu_color', array(
        'label'	   => __( 'Mobile Menu Text Color', 'sensible' ),
        'section'  => 'nav',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_mobile_menu_bg', array(
        'label'	   => __( 'Mobile Menu Background', 'sensible' ),
        'section'  => 'nav',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_mobile_menu_link', array(
        'label'	   => __( 'Mobile Menu Link', 'sensible' ),
        'section'  => 'nav',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_mobile_menu_hover', array(
        'label'	   => __( 'Mobile Menu Hover', 'sensible' ),
        'section'  => 'nav',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_mobile_menu_hover_bg', array(
        'label'	   => __( 'Mobile Menu Background Hover', 'sensible' ),
        'section'  => 'nav',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_mobile_menu_title', array(
        'label'	   => __( 'Mobile Menu Title', 'sensible' ),
        'section'  => 'nav',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_mobile_menu_title_bg', array(
        'label'	   => __( 'Mobile Menu Title Background', 'sensible' ),
        'section'  => 'nav',
	...
	$wp_customize->add_section( 'sensible_header_options' , array(  
	    'title'       => __( 'Secondary Header', 'sensible' ),
	    'priority'    => 39,
	    'description' => __( 'Edit your Secondary Header options.', 'sensible' ),
		'panel'		  => 'sensible_nav_panel',
	));
    ...
    $wp_customize->add_control( 
        ...
        array(
            'type' => 'checkbox',
            'label' => __('Hide Secondary Header', 'sensible'),
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_secondary_header_bg', array(
        'label'	   => __( 'Secondary Header Background', 'sensible' ), 
        'section'  => 'sensible_header_options',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_secondary_header_text', array(
        'label'	   => __( 'Secondary Header Text', 'sensible' ), 
        'section'  => 'sensible_header_options',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_secondary_social_color', array(
        'label'	   => __( 'Secondary Header Social Icon', 'sensible' ), 
        'section'  => 'sensible_header_options',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_secondary_social_color_hover', array(
        'label'	   => __( 'Secondary Header Social Icon Hover', 'sensible' ), 
        'section'  => 'sensible_header_options',
	...
	$wp_customize->add_section( 'sensible_animations' , array(  
	    ...
	    'priority'    => 39,
	    'description' => __( 'We can make things fly across the screen.', 'sensible' ),
	));
    ...
    $wp_customize->add_control( 
        ...
        array(
            'type' => 'checkbox',
            'label' => __('Check this box to disable animations.', 'sensible'),
    ...
    $wp_customize->add_section( 'sensible_logo_section' , array(  
	    ...
	    'priority'    => 21, 
	    'description' => __( 'Upload a logo to replace the default site name and description in the header. Also, upload your site favicon and Apple Icons.', 'sensible' ),
	));
    ...
    'capability'     => 'edit_theme_options',
    'theme_supports' => '',
    'title'          => __( 'Home Hero Section', 'sensible' ),
    'description'    => __( 'Edit your the top of your home page.  Use Slider, Video, or Static Hero Image.', 'sensible' ),
	));
	
	// Slider Section
	$wp_customize->add_section( 'sensible_slider_section', array(
		'title'          => __( 'Slider', 'sensible' ),
		'priority'       => 24,
		'description' => __( 'Edit your Slider settings here. Add your slides under <b>Posts -> Add New then check the Feature as Home Page Slider box</b>. Adding one slide will set a single background.', 'sensible' ),
		'panel' => 'hero_panel',
	));
    ...
    'label' => __( 'Slider Speed', 'sensible' ),
	'description' => __( 'Change the speed of your slider in ms (1000 = 1s)', 'sensible' ),
    'section' => 'sensible_slider_section', 
    ...
    'label' => __( 'Slider Height', 'sensible' ), 
	'description' => __( 'Adjust the height of your slider. Just enter in a numerical value, as the px is already coded in (ex. 650).', 'sensible' ),  
    'section' => 'sensible_slider_section', 
	...
	$wp_customize->add_section( 'sensible_video_section', array(
		'title'          => __( 'Video Banner Option', 'sensible' ),
		'priority'       => 24,
    ...
    'label' => __( 'Video Banner .mp4 File', 'sensible' ), 
	'description' => __( 'ex: video_banner.mp4', 'sensible' ),
    ...
    'label' => __( 'Video Banner .webm File', 'sensible' ),
	'description' => __( 'ex: video_banner.webm', 'sensible' ), 
    'section' => 'sensible_video_section',
    ...
    'label' => __( 'Video Banner .ogv File', 'sensible' ),
	'description' => __( 'ex: video_banner.ogv', 'sensible' ),  
    'section' => 'sensible_video_section', 
	...
	$wp_customize->add_section( 'sensible_hero_section', array(
		'title'          => __( 'Static Image Background', 'sensible' ),
		'priority'       => 25, 
		'description' => __( 'Edit your Background Image. Note: must select Home Page - Hero Background to use this section.', 'sensible'),  
		'panel' => 'hero_panel',
	)); 
    ...
    'label' => __( 'Hero Heading', 'sensible' ),    
    'section' => 'sensible_hero_section',
    ...
    'label' => __( 'Hero Button Text', 'sensible' ),   
    'section' => 'sensible_hero_section',
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'hero_button_url', array( 
    	'label' => __( 'Hero Button URL', 'sensible' ), 
    	'section' => 'sensible_hero_section', 
		'type' => 'dropdown-pages',
	...
	$wp_customize->add_control( 'page_url_text', array(
		'type'     => 'url',
		'label'    => __( 'External URL Option', 'sensible' ), 
		'description' => __( 'If you use an external URL, leave the Widget Button Link above empty. Must include http:// before any URL.', 'sensible' ), 
		'section'  => 'sensible_hero_section',   
	...
	$wp_customize->add_section( 'sensible_hero_colors_section', array(
		'title'          => __( 'Home Hero Colors', 'sensible' ),
		'priority'       => 30, 
		'description' => __( 'Edit your Home Hero color options', 'sensible'),  
		'panel' => 'hero_panel',
	)); 
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_slider_button_bg_color', array(
        'label'	   => __( 'Button Color', 'sensible'),
        'section'  => 'sensible_hero_colors_section',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_slider_button_text_color', array(
        'label'	   => __( 'Button Text Color', 'sensible'),
        'section'  => 'sensible_hero_colors_section',
    ...
    'capability'     => 'edit_theme_options',
    'theme_supports' => '',
    'title'          => __( 'Home Page Options', 'sensible' ),
    'description'    => __( 'Edit your Home Page options', 'sensible' ), 
	));
	
	// Social Section 
	$wp_customize->add_section( 'sensible_settings', array(
            'title'          => __( 'Home Page Social Icons', 'sensible' ),
            'priority'       => 10,
    ...
    array(
        'type' => 'checkbox',
        'label' => __( 'Hide Home Social Section', 'sensible' ),
	...
	//Social Text
		...
		'label'    => __( 'Social Icon Heading Text', 'sensible' ),
		'section'  => 'sensible_settings',
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_social_bg', array(
        'label'	   => __( 'Background Color', 'sensible' ),
        'section'  => 'sensible_settings',
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_social_border', array(
        'label'	   => __( 'Border Color', 'sensible' ),
        'section'  => 'sensible_settings',
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_social_color', array(
        'label'	   => __( 'Social Icon Color', 'sensible' ),
        'section'  => 'sensible_settings',
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_social_color_hover', array(
        'label'	   => __( 'Social Icon Hover Color', 'sensible' ), 
        'section'  => 'sensible_settings',
	...
	$wp_customize->add_section( 'sensible_intro_section', array(
		'title'          => __( 'Home Intro Section', 'sensible' ),
		'priority'       => 20,
		'description' => __( 'Edit your home page Intro section content', 'sensible' ),
		'panel' => 'home_page_panel',
	));
    ...
    array(
        'type' => 'checkbox',
        'label' => __( 'Hide Home Intro Section', 'sensible' ),
	...
	$wp_customize->add_section( 'sensible_services_section', array(
		'title'          => __( 'Home Services Content', 'sensible' ),
		'priority'       => 30,
    ...
    array(
        'type' => 'checkbox',
        'label' => __( 'Hide Services Section', 'sensible' ), 
    ...
    $wp_customize->add_control( 'services_number_display', array(
        ...
        'priority'    => 30,
        'section'     => 'sensible_services_section', 
        'label'       => __('Number of Services', 'sensible'),
		'description'       => __('Set the number of Services to display.', 'sensible'), 
        'input_attrs' => array( 
            'min'   => 1,
            'max'   => 100,  
            'step'  => 1
    ...
    $wp_customize->add_control( 'services_columns_number', array(
        ...
        'priority'    => 40,
        'section'     => 'sensible_services_section', 
        'label'       => __('Services Columns Width', 'sensible'),
		'description'       => __('Set the width of the each Services Column. 1 = 100% of the width, 4 = 25% of the width.', 'sensible'), 
        'input_attrs' => array( 
            'min'   => 1,
            'max'   => 5,  
            'step'  => 1
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'service_button_text', array(
		'label'    => __( 'Services Button Text', 'sensible' ),
		'section'  => 'sensible_services_section', 
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'service_button_url', array( 
    	'label' => __( 'Service Button URL', 'sensible' ), 
    	'section' => 'sensible_services_section', 
		'type' => 'dropdown-pages',
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_services_icon_bg', array(
        'label'	   => __( 'Icon Background', 'sensible' ),
        'section'  => 'sensible_services_section',
	...
	$wp_customize->add_section( 'sensible_details_section', array(
		'title'          => __( 'Home Details Section', 'sensible' ),
		'priority'       => 40,
    ...
    array(
        'type' => 'checkbox',
        'label' => __( 'Hide Details Section', 'sensible' ), 
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'sensible_detail_background', array(
		'type'  => 'image', 
		'label'	=> __( 'Detail Image Background', 'sensible' ),
		'section'	=> 'sensible_details_section',
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_details_title_divider', array(
        'label'	   => __( 'Divider Color', 'sensible' ),
        'section'  => 'sensible_details_section',
	...
	$wp_customize->add_section( 'sensible_blog_section', array(
		'title'          => __( 'Home Blog Section', 'sensible' ),
		'priority'       => 50,
    ...
    array(
        'type' => 'checkbox',
        'label' => __( 'Hide Blog Section', 'sensible' ),
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_blog_cta', array(
        'label'	   => __( 'Call-to-Action Background', 'sensible' ),
        'section'  => 'sensible_blog_section',
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_blog_cta_button', array(
        'label'	   => __( 'Call-to-Action Button', 'sensible' ),
        'section'  => 'sensible_blog_section', 
	...
	$wp_customize->add_section( 'sensible_team_section', array(
		'title'          => __( 'Home Team Member Section', 'sensible' ),
		'priority'       => 60,
    ...
    array(
        'type' => 'checkbox',
        'label' => __( 'Hide Team Member Section', 'sensible' ),  
    ...
    $wp_customize->add_control( 'team_number_display', array(
        ...
        'priority'    => 30,
        'section' => 'sensible_team_section', 
        'label'       => __('Number of Team Members', 'sensible'),
		'description'       => __('Set the number of Team Members to display.', 'sensible'), 
        'input_attrs' => array( 
            'min'   => 1,
            'max'   => 100,  
            'step'  => 1
    ...
    $wp_customize->add_control( 'team_columns_number', array(
        ...
        'priority'    => 40,
        'section'     => 'sensible_team_section', 
        'label'       => __('Team Member Columns Width', 'sensible'),
		'description'       => __('Set the width of the each Team Member Column. 1 = 100% of the width, 4 = 25% of the width.', 'sensible'), 
        'input_attrs' => array( 
            'min'   => 1,
            'max'   => 5,  
            'step'  => 1
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'team_button_text', array(
		'label'    => __( 'Team Member Button Text', 'sensible' ),
		'section'  => 'sensible_team_section', 
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'team_button_url', array( 
    	'label' => __( 'Team Member Button URL', 'sensible' ), 
    	'section' => 'sensible_team_section', 
		'type' => 'dropdown-pages',
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_team_icon_hover_color', array(
        'label'	   => __( 'Icon Hover Color', 'sensible' ),
        'section'  => 'sensible_team_section', 
	...
	$wp_customize->add_section( 'frontpage-skills' , array(
    	'title' => __( 'Home Skills Section', 'sensible' ),
    	'priority' => 70, 
    ...
    array(
        'type' => 'checkbox',
        'label' => __( 'Hide Skills Section', 'sensible' ),
    ...
    new WP_Customize_Color_Control(
        ...
        'skill_bar_color',
        array(
            'label'      => __( 'Skill Bar Color', 'sensible' ),
            'section'    => 'frontpage-skills', 
    ...
    new WP_Customize_Color_Control(
        ...
        'skill_bar_bg_color',
        array(
            'label'      => __( 'Skill Bar Background', 'sensible' ),
            'section'    => 'frontpage-skills', 
	...
	$wp_customize->add_section( 'sensible_widget_section', array(
		'title'          => __( 'Home Widget Section', 'sensible' ),
		'priority'       => 80,
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'sensible_main_widget_background', array(
		'type'  => 'image',
		'label'	=> __( 'Home Widget Background', 'sensible' ),
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'sensible_widget_columns', array(
		'label'    => __( 'Number of Widget Columns', 'sensible' ),
		'description'    => __( 'Select the number of widget columns to use. 1 Column will take up the entire widget area, while 4 columns will give space to use 4 widgets for content.', 'sensible' ),
		'section'  => 'sensible_widget_section', 
		'settings' => 'sensible_widget_columns',  
		'type'     => 'radio',
		'priority'   => 20,  
		'choices'  => array(
			'option1' => __( '1 Column', 'sensible' ),
			'option2' => __( '2 Columns', 'sensible' ),
			'option3' => __( '3 Columns', 'sensible' ),
			'option4' => __( '4 Columns', 'sensible' ),
			),
	)));
    ...
    array(
        'type' => 'checkbox',
        'label' => __( 'Hide Widget Section', 'sensible' ),  
        'section' => 'sensible_widget_section',
		'priority'   => 1
    ));
	...
	$wp_customize->add_control( 'sensible_page_url_text', array( 
		'type'     => 'url',
		'label'    => __( 'External Button URL Option', 'sensible' ),
		'description' => __( 'If you use an external URL, leave the Widget Button Link above empty. Must include http:// before any URL.', 'sensible' ),
		'section'  => 'sensible_widget_section',  
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_widget_cta_button', array(
        'label'	   => __( 'Widget Button', 'sensible' ),
        'section' => 'sensible_widget_section',
	...
	$wp_customize->add_section( 'sensible_map' , array(
    	'title' => __( 'Home Map Section', 'sensible' ),
    	'priority' => 90,
    	'description' => __( 'Customize your home page map', 'sensible' ),
		'panel'		=> 'home_page_panel',
	) ); 
    ...
    'label' => __( 'Map URL', 'sensible' ),
	'description' => __( 'Copy the Google Map embed URL (ex: https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3022) and paste it in the textbox below. The URL is located after the src in the embed snippet. Do not include the width, height, frameborder, or style.', 'sensible' ), 
    'section' => 'sensible_map',
    ...
    'capability'     => 'edit_theme_options',
    'theme_supports' => '',
    'title'          => __( 'Footer Options', 'sensible' ),
    'description'    		 => __( 'Edit your footer options', 'sensible' ),
	)); 
	
	// Add Footer Section
	$wp_customize->add_section( 'footer-social-icons' , array(
    	'title' => __( 'Footer Social Icons', 'sensible' ),
    	'priority' => 30,
    	'description' => __( 'Customize the social media icons of the footer area', 'sensible' ),
		'panel' => 'sensible_footer_panel'
	));
	 
	// Add Footer Section
	$wp_customize->add_section( 'footer-custom' , array(
    	'title' => __( 'Top Footer Option', 'sensible' ),
    	'priority' => 30,
    	'description' => __( 'Customize the top portion of your footer area', 'sensible' ),
		'panel' => 'sensible_footer_panel'
	));
	
	// Add Footer Section
	$wp_customize->add_section( 'bottom-footer-custom' , array(
    	'title' => __( 'Bottom Footer Options', 'sensible' ),
    	'priority' => 35,
    	'description' => __( 'Customize the bottom portion of you footer area', 'sensible' ),
		'panel' => 'sensible_footer_panel'
	));
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'sensible_footer_home', array(
		'label'    => __( 'Footer Form Area', 'sensible' ),
    ...
    array(
        'type' => 'checkbox',
        'label' => __( 'Hide Footer Social Section', 'sensible' ),
	...
	// Social Text
		...
		'label'    => __( 'Footer Social Heading Text', 'sensible' ),
		'section'  => 'footer-social-icons',
    ...
    array(
        'type' => 'checkbox',
        'label' => __( 'Hide Footer Top Section', 'sensible' ),
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_top_footer_bg', array(
        'label'	   => __( 'Top Footer Background', 'sensible'),  
        'section'  => 'footer-custom',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_top_footer_title', array(
        'label'	   => __( 'Top Footer Title', 'sensible'),  
        'section'  => 'footer-custom',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_top_footer_icon', array(
        'label'	   => __( 'Top Footer Icon', 'sensible'),  
        'section'  => 'footer-custom',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_top_footer_titles', array(
        'label'	   => __( 'Top Footer Contact Titles', 'sensible'),  
        'section'  => 'footer-custom',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_top_footer_text', array(
        'label'	   => __( 'Top Footer Text', 'sensible'),  
        'section'  => 'footer-custom',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sensible_top_footer_contact_block', array(
        'label'	   => __( 'Top Footer Contact Block', 'sensible'),  
        'section'  => 'footer-custom',
    ...
    $wp_customize->add_section( 'sensible_layout_section' , array( 
	    'title'       => __( 'Blog Layout', 'sensible' ), 
	    'priority'    => 35, 
	    'description' => __( 'Change blog options for Sensible', 'sensible' ),
	));
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'sensible_blog_title', array(
		'label'    => __( 'Posts Page Title', 'sensible' ),
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'sensible_blog_bg', array( 
		'label'    => __( 'Posts Page Image', 'sensible' ),
		'section'  => 'sensible_layout_section', 
    ...
    $wp_customize->add_control( 'exc_length', array( 
		...
		'priority'   => 40,
        'description' => __('Default: 30 words', 'sensible'), 
        'input_attrs' => array(
            'min'   => 10,
            'max'   => 200,
            'step'  => 5
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'sensible_post_nav_terms', array(
		'label'    => __( 'Post Navigation Excluded Categories', 'sensible' ),
		'description'    => __( 'If you would like to exclude certain categories from the navigation at the bottom of single post pages, enter in the category numbers in the field below. Separate each number with a comma. For example: 15, 17, 18', 'sensible' ),
		'section'  => 'sensible_layout_section',   
	...
	$wp_customize->add_section( 'sensible_shop_archive', array(
		'title'          => __( 'Shop Options', 'sensible' ),
		'priority'       => 46,
		'description' => __( 'Use this section to edit your Shop archive.', 'sensible' ),
	));
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'sensible_archive_bg', array( 
		'label'	=> __( 'Shop Archive Header Background', 'sensible' ),
		'type' 			=> 'image',
    ...
    $wp_customize->add_control( 'sensible_body_size', array(
        ...
        'label'       => __('Body font size', 'sensible'),
        'input_attrs' => array(
            'min'   => 10,
            'max'   => 28,
            'step'  => 1
